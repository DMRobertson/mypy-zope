...
class IReactorTCP(Interface):
    def listenTCP(
        port: int, factory: "Any", backlog: int, interface: str
    ) -> "IListeningPort":
        """
        Connects a given protocol factory to the given numeric TCP/IP port.

        @param port: a port number on which to listen
        @param factory: a L{twisted.internet.protocol.Any} instance
    ...
    def connectTCP(
        ...
        @return: An object which provides L{IConnector}. This connector will
                 ...
                 L{Any<twisted.internet.protocol.Any>}
                 docs for details.
        """
...
class IReactorUNIX(Interface):
    ...
    def connectUNIX(
        address: str, factory: "Any", timeout: float, checkPID: bool
    ) -> IConnector:
        """
    ...
    def listenUNIX(
        address: str, factory: Any, backlog: int, mode: int, wantPID: bool
    ) -> "IListeningPort":
        """
...
class IReactorUNIXDatagram(Interface):
    ...
    def listenUNIXDatagram(
        address: str, protocol: Any, maxPacketSize: int, mode: int
    ) -> "IListeningPort":
        """
...
class IReactorUDP(Interface):
    ...
    def listenUDP(
        port: int, protocol: Any, interface: str, maxPacketSize: int
    ) -> "IListeningPort":
        """
...
class IReactorSocket(Interface):
    ...
    def adoptStreamPort(
        fileDescriptor: int, addressFamily: "AddressFamily", factory: "Any"
    ) -> "IListeningPort":
        """
        ...
        @param factory: A L{Any} instance to use to create new
    ...
    def adoptStreamConnection(
        ...
        @param addressFamily: The address family (or I{domain}) of the socket.
            For example, L{socket.AF_INET6}.
        @param factory: A L{Any} instance to use to create a new
...
class IStreamClientEndpoint(Interface):
    """
    A stream client endpoint is a place that L{Any} can connect to.
